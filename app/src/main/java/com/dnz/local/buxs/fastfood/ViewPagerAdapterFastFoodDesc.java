...
public class ViewPagerAdapterFastFoodDesc extends PagerAdapter {
    private static final String TAG = "ViewPagerAdapter";

    private FastFoodDescActivity context;
    private LayoutInflater inflater;

    public ViewPagerAdapterFastFoodDesc(FastFoodDescActivity context) {
