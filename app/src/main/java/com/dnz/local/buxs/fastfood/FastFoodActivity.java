...
public class FastFoodActivity extends AppCompatActivity implements MyIFace.IFGetCartCount {
    ...
    public RecyclerViewAdapterFastFoodActivity viewAdapter;
    ...
    public void initRecyclerView() {
        ...
        viewAdapter = new RecyclerViewAdapterFastFoodActivity(this);
...
//            throw new IllegalStateException("Invalid Key for cache");
    ...
    public void startCartActivity() {
        Intent i = new Intent(FastFoodActivity.this, CartActivity.class);
        startActivity(i);
    }
    ...
    private class CustomJSONResponseListener implements Response.Listener<JSONObject>, Response.ErrorListener {
        ...
        public void onResponse(JSONObject response) {
            ...
            if (!isAnimationShown) {
                MyAnimations.dismissLoading(FastFoodActivity.this);
                MyAnimations.showSuccess(FastFoodActivity.this);

                Timer timer = new Timer();
                MyIFace.MyTimedClass myTimedClass = new MyIFace.MyTimedClass(FastFoodActivity.this, new MyIFace.TaskInterval() {
                    @Override
                    public void runOnUiThread(Object... objects) {
                        MyAnimations.dismissSuccess(FastFoodActivity.this);
                    }
                });
        ...
        public void onErrorResponse(VolleyError error) {
            MyAnimations.dismissLoading(FastFoodActivity.this);
            try {
                MyAnimations.showError(FastFoodActivity.this, error.getCause().getClass()
                        .getCanonicalName());

            } catch (NullPointerException e) {
                MyAnimations.showError(FastFoodActivity.this, "Failed to connect" );
            }
